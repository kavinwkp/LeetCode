...
namespace TinySTL{
	...
	public:
		...
		friend bool operator== (const pair<Q1, Q2>& lhs, const pair<Q1, Q2>& rhs);
		template <class Q1, class Q2>
		friend bool operator!= (const pair<Q1, Q2>& lhs, const pair<Q1, Q2>& rhs);
		template <class Q1, class Q2>
		friend bool operator<  (const pair<Q1, Q2>& lhs, const pair<Q1, Q2>& rhs);
		...
		friend bool operator>= (const pair<Q1, Q2>& lhs, const pair<Q1, Q2>& rhs);
		template <class Q1, class Q2>
		friend void swap(pair<Q1, Q2>& x, pair<Q1, Q2>& y);
	...
	template <class Q1, class Q2>
	bool operator== (const pair<Q1, Q2>& lhs, const pair<Q1, Q2>& rhs){
	...
	template <class Q1, class Q2>
	void swap(pair<Q1, Q2>& x, pair<Q1, Q2>& y){
		x.swap(y);
	}
	// ******* [make_pair] ************
	template<class U, class V>
