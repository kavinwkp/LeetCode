...
namespace TinySTL{
	...
	public:
		template <class Itor>
		friend bool operator == (const reverse_iterator_t<Itor>& lhs, 
								const reverse_iterator_t<Itor>& rhs);
		template <class Itor>
		friend bool operator != (const reverse_iterator_t<Itor>& lhs, 
								const reverse_iterator_t<Itor>& rhs);
		template <class Itor>
		...
		template <class Itor>
		friend reverse_iterator_t<Itor> operator + (
			typename reverse_iterator_t<Itor>::difference_type n,
			const reverse_iterator_t<Itor>& rev_it);
		template <class Itor>
		friend typename reverse_iterator_t<Itor>::difference_type operator- (
			const reverse_iterator_t<Itor>& lhs,
			const reverse_iterator_t<Itor>& rhs);
	...
	template <class Itor>
	bool operator == (const reverse_iterator_t<Itor>& lhs, const reverse_iterator_t<Itor>& rhs){
	...
	template <class Itor>
	reverse_iterator_t<Itor> operator + (
		typename reverse_iterator_t<Itor>::difference_type n,
		const reverse_iterator_t<Itor>& rev_it){
		return rev_it + n;
	}
	template <class Itor>
	typename reverse_iterator_t<Itor>::difference_type operator - (
		const reverse_iterator_t<Itor>& lhs,
		const reverse_iterator_t<Itor>& rhs){
		return lhs.cur_ - rhs.cur_;
	}
